...
public class Kernel extends Thread
{
  ...
  private static int maxPhysPageIndex = 31;
  ...
  public void init( String commands , String config )  
  {
    ...
    if ( config != null )
    {
        ...
        while ((line = in.readLine()) != null) 
        {
          ...
          { 
            ...
            while (st.hasMoreTokens()) 
            {
              ...
              maxPhysPageIndex = (maxVirtPageIndex - 1) / 2;
      ...
      for (i = 0; i <= maxVirtPageIndex; i++)
      {
        ...
        if (i <= maxPhysPageIndex){
          physicalUnmapped.addElement(i);
        }
      }
...

        {
          ...
          { 
            ...
            { 
              ...
              if (page.physical != -1){
                workingSet.addElement(id);
                physicalUnmapped.removeElement(page.physical);
              }
            }
          }
          ...
          if (line.startsWith("tick"))
          {
            ...
            while (st.hasMoreTokens()){
              ...
              if (tick < 1)
              {
                System.out.println("MemoryManagement: tick can't be less than 1 ");
                System.exit(-1);
              }
            }
          }
          if (line.startsWith("tau"))
          {
            ...
            while (st.hasMoreTokens()){
              ...
              if (tau <= tick)
              {
                System.out.println("MemoryManagement: tau can't be less or equal to tick ");
                System.exit(-1);
              }
            }
          }
  ...
  public void step()
  {
    ...
    if ( instruct.inst.startsWith( "READ" ) ) 
    {
      ...
      if ( page.physical == -1 ) 
      {
        ...
        if (!physicalUnmapped.isEmpty()){
          int anyPhysical = physicalUnmapped.elementAt(0);
          page.physical = anyPhysical;
    ...
    {
      Page page = ( Page ) memVector.elementAt( i );
      if ( page.R == 1 && (currentTime - page.lastTouchTime) == tick )
      {
        page.R = 0;
        page.M = 0;
      }
